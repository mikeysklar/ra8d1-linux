 ...
 *
 * Local changes, all so this builds freestanding for the Cortex-M85:
 *   - dropped <stdio.h> from this header (it was unused here)
 *   - z80.c: stdio calls moved behind Z80_TRACE (see the note at its top)
 * The instruction semantics are untouched; the host harness still runs
 * prelim/zexdoc/zexall against this exact copy.
 */
#ifndef Z80_Z80_H_
#define Z80_Z80_H_

#include <stddef.h>   /* NULL; used to come in via <stdio.h> */
#include <stdint.h>
#include <stdbool.h>
